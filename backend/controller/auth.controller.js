...
export const signup = async (req, res, next) => {
  ...
  const boyProfilePic = `https://avatar.ir.liara.run/public/boy?username=${username}`
  const girlProfilePic = `https://avatar.ir.liara.run/public/girl?username=${username}`
